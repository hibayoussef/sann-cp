...
export const productSchema = z.object({
  ...
  tax_id: z.coerce.number().min(1, "Tax is required").nullable(),
  brand_id: z.coerce.number().min(1, "Brand is required").nullable(),
  category_id: z.coerce.number().min(1, "Category is required").nullable(),
  sub_category_id: z.coerce.number().optional().nullable(),
  unit_id: z.coerce.number().min(1, "Unit is required").nullable(),
  sub_units: z.array(z.object({ id: z.coerce.number().min(1).nullable() })).optional(),
  warranty_id: z.coerce.number().optional().nullable(),
  alert_quantity: z.coerce.number().optional(),
  sale_account: z.coerce.number().optional().nullable(),
  purchase_account: z.coerce.number().optional().nullable(),
  sale_return_account: z.coerce.number().optional().nullable(),
  purchase_return_account: z.coerce.number().optional().nullable(),
