...
export default function Settings() {
  return (
    <div className="p-6 bg-gray-50 min-h-screen px-4 sm:px-10 md:px-12 lg:px-20 text-sm">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
        {categories.map((category, index) => (
          <div key={index} className="bg-white shadow-md hover:shadow-lg transition rounded-lg p-4">
