...
import { customerSchema, CustomerType } from "@/components/lib/validations/customer";
...
export const OtherDetailsTab = ({
  ...
  const [currencyOptions, setCurrencyOptions] = useState<
    Array<{ value: string; label: string }>
  >([]);
  const [portalAccessOptions] = useState<Array<{ value: "0" | "1"; label: string }>>([
    { value: "1", label: "Enabled" },
    { value: "0", label: "Disabled" },
  ]);
  const [portalLanguageOptions] = useState<Array<{ value: "en" | "ar"; label: string }>>([
  ...
  }, [countriesData, branches, paymentsTerm, currencies]);
  ...
  }, [selectedNationalityId, countriesData, setValue, trigger, currencyOptions]);
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            {...register("exchange_rate", { 
              required: isFieldRequired('exchange_rate') ? "The exchange rate field is required." : false 
            })}
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <CustomSelect<"0" | "1">
            ...
            onChange={(value) => handleSelectChange("portal_access", value)}
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            step={0.01}
            {...register("balance", { 
              required: isFieldRequired('balance') ? "The balance field is required." : false 
            })}
