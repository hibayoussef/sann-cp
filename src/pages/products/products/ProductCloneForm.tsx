...
export default function ProductCloneForm() {
  const { id } = useParams();
  ...
  useEffect(() => {
    ...
    const defaultValues: any = {
      product_name_en: isClone
        ? `${productData.product_name_en} (Copy)`
        : productData.product_name_en || "",
      product_name_ar: isClone
        ? `${productData.product_name_ar} (نسخة)`
        : productData.product_name_ar || "",
      sku: isClone ? "" : productData.sku || "",
